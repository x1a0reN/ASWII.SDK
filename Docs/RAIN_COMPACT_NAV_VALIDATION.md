...
Visual Studio 2026 MSBuild Debug 构建成功，PostBuild 复制 6 个文件。构建前确认新
`ASWDEBUG.dll` 与已部署版本不同，旧 DLL 已备份到：

```text
C:\Users\x1a0reN\AppData\Local\ASWII\Data\ASWDEBUG.DeployBackups\20260722_193922340\Managed\ASWDEBUG.dll
```

备份长度为 486,912 bytes，SHA-256 为
...
| 文件 | 长度 | SHA-256 |
|---|---:|---|
| `ASWDEBUG.dll` | 494,592 | `4CB87AF41B02782D52755AB67624C56102FA81F7A886BAE7ABB8CBD582B4A570` |
